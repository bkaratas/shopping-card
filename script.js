...
const cartContent = document.querySelector(".card-list");
...
class Products{
    async getProducts() {
        try{
            let result = await fetch("https://641f8555f228f1a83eb7bd01.mockapi.io/products");
...
class UI{
    ...
    saveCartValues(cart){
        ...
        cart.map(item => {
            ...
            itemsTotals += item.amount;
        });
        
        cartTotal.innerText = parseFloat(tempTotal.toFixed(2)); 
        cartItems.innerText = itemsTotals;
